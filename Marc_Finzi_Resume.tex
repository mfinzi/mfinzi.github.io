...
\address{156 Orchard Street, NY, NY} % optional, remove the line if not wanted
...
\vspace*{-10mm}
\section{Education}
\cventry{2019 - ????}{Ph.D. in Computer Science}{NYU  Courant}{NYC}{}{}
...
\cventry{2019 - Present}{PhD Student}{Andrew G. Wilson's lab}{NYU}{}{
Building in inductive biases for structured data outside of Images,Video,Text such as with
\begin{itemize}
\item Irregularly spatial data
...
\end{document}
%\section{Reviewing}
%\cvline{Conferences}{AISTATS 2019, ICML 2019, NeurIPS 2019, ICLR 2020}
...
% \cvline{Languages}{Python: 30k+ LoC, C\texttt{++}: 3k+ LoC, \LaTeX.}
