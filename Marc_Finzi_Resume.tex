...
Current Research Interests
    \begin{itemize}
        \item Semi-supervised learning, heterogeneous sources of supervision
    	\item Visual attention mechanisms and structured prediction
        \item Wide optima and loss surface geometry
    \end{itemize}
    }
\vspace*{3mm} 
...
\vspace*{3mm} 
\cventry{Summers 2014, 2015}{Internship at NASA}{Goddard Space Flight Center}{Greenbelt, MD}{}{
	\begin{itemize}
